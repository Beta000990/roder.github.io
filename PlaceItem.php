...
$gameitem->bindParam(':id', $id, PDO::PARAM_INT);
$gameitem->execute();
...
$creatorq->bindParam(':creator', $game['creator_id'], PDO::PARAM_INT);
$creatorq->execute();
...
<div id="Item">
  <div id="Summary" style="width:251px;">
    <h3><?php echo htmlspecialchars($sitename); ?> Place</h3>
    <div id="Creator" class="Creator">
      <div class="Avatar">
        <img src="data:image/jpeg;base64, <?php echo htmlspecialchars($creator['thumbnail']); ?>" frameborder="0" scrolling="no" width="100"></img>
    ...
    <div>
      ...
      <div id="Description" style="width:auto;"><?php echo htmlspecialchars($game['description']); ?></div>
      </div>
            <div id="ReportAbuse">
