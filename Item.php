...
if ($resultCheck > 0) {
    ...
    metatag(htmlspecialchars($result['name']), htmlspecialchars($result['description']), htmlspecialchars($result['thumbnail']));
...
<?php if($_USER['USER_PERMISSIONS'] == 'Administrator' OR $creator['id'] == $_USER['id']) {?>          
          <a id="ctl00_cphRoblox_RemoveFromInventoryButton" class="Button" href="/api/RenderItems.php?id=<?=$result['id'];?>">Render Item</a>
<?}?>
    <?php if($owned == 'yes') {
          ?>
...
?>
    ...
    <div class="Comment">
        <div class="Commenter">
            <div class="Avatar">
                <a id="ctl00_cphRoblox_CommentsPane_CommentsRepeater_ctl01_AvatarImage" title="<?php echo htmlspecialchars($creator['username']); ?>" href="/User.aspx?id=1" style="display:inline-block;height:64px;width:64px;cursor:pointer;"><img src="data:image/jpeg;base64, <?php echo htmlspecialchars($creator['thumbnail']); ?>" width="65" height="65" border="0" id="img" alt="<?php echo htmlspecialchars($creator['username']); ?>"></a>
            </div>
        </div>
        <div class="Post">
            <div class="Audit">
                ...
                echo htmlspecialchars($fpostedat);
                ?>
                by
                <a id="ctl00_cphRoblox_CommentsPane_CommentsRepeater_ctl01_UsernameHyperLink" href="User.aspx?id=<?php echo htmlspecialchars($creator['id']); ?>"><?php echo htmlspecialchars($creator['username']); ?></a>
            </div>
            ...
            <div id="ctl00_cphRoblox_CommentsPane_CommentsRepeater_ctl01_Actions" class="Actions">
                <div id="ctl00_cphRoblox_CommentsPane_CommentsRepeater_ctl01_AbuseReportButton_AbuseReportPanel" class="ReportAbusePanel">
